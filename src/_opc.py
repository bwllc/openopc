...
# Copyright (c) 2020 John Ladasky (john.ladasky@gmail.com)
#
# John Ladasky 2020 -- Proposals: refactor this code.  Fix indentation
# to the four-space standard.  Use the argparse module in the Python
# standard library instead of this hand-coded parser.
#
###########################################################################
...
def main():
    ...
    """
    Enclosing ALL code in main() allows setuptools to find this
    function to build the entry_point script.  Attempting to 
    enclose only the parser portion of the code in main() results
    in many UnboundLocalError problems.  However, import scheme
    also has to change, see below.
    """
...
#        global write   # It's no longer global!  JJL2
        name_idx = 0
    ...
    # Parse command line arguments.  This is where main() "really" starts.
    # I just don't want to fight with UnboundLocalError problems right now.
    ...
    # Tag list passed via standard input
    if pipe:
        try:
